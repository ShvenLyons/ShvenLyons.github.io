...
📌 Here is my <a class="btn btn--primary" href="{{ '/files/CV_ShiwenLiu.pdf' | relative_url }}" target="_blank" rel="noopener">CV (PDF)</a> for your reference, last updated in Aug. 2025. 🤩


## Research Interests
- **AI Privacy**: privacy-preserving modeling, data minimization, and consent-aware usage
- **Trustworthy AI**: reliability, robustness, faithfulness, and risk-aware evaluation
- **RAG**: retrieval quality, context governance, and leakage-resistant prompting


Beyond these core areas, my broader interests center on **practice-oriented AI**, including **LLM applications** such as interview, education, and healthcare assistants, as well as domain-aware tooling with responsible deployment.
...
* ![](https://img.shields.io/badge/Jan.%202025-00FF00) 📚 ~~[Lab] IIoT_testbed & EVC_Smart_Grid Evaluation~~
* ![](https://img.shields.io/badge/Dec.%202024-1E90FF) ✈️ Travel to Spain
* ![](https://img.shields.io/badge/Dec.%202024-1E90FF) ✈️ Travel to Jersey
* ![](https://img.shields.io/badge/Dec.%202024-1E90FF) ✈️ Travel to Glasgow & Edinburgh
* ![](https://img.shields.io/badge/Sep.%202024-00FF00) 📚 Moved to Bristol, starting my graduate study career
* ![](https://img.shields.io/badge/May.%202024-00FF00) 📚 Received **AMD 3+1** program offer (University of Bristol)


<!-- Travel Map (inserted here) -->
<div style="position:relative;width:100%;max-width:100%;padding-top:56.25%;overflow:hidden;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,.08);margin:12px 0 20px;">
  <iframe
    src="https://www.google.com/maps/d/embed?mid=1QSy5kcdHmecmyXv-9EMyVYQRcJOYzMk&ehbc=2E312F"
    title="Travel Footsteps Map"
    loading="lazy"
...
<small style="display:block;margin-top:.25rem;opacity:.8;">
  If Empty, Click and Access：<a href="https://www.google.com/maps/d/viewer?mid=1QSy5kcdHmecmyXv-9EMyVYQRcJOYzMk&hl=en" target="_blank" rel="noopener">View on Google My Maps</a>
</small>
